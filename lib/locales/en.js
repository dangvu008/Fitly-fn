(function (global) {
    ...
    global.FITLY_LOCALES.en = {
        ...
        session_expired_relogin: 'Your session has expired. Please log in again and retry.',
        ...
        // Gems packages
        gems_store_title: 'Gem Store 💎',
        gems_benefit_1: 'Unlimited try-ons',
        gems_benefit_2: 'Personal AI stylist',
        gems_benefit_3: 'Refund if unsatisfied',
        gem_per_try: '/gem',
        ...
        payment_note: 'Secure payment via Polar.sh',
        ...
        error_overlay: {
            title: 'Oopsie, something broke... 🥺',
            apology: 'So sorry about that! Please try again for me~',
        },
        ...
        mix_match_toggle: 'Mix & Match',
        mix_match_toggle_tip: 'On: mix outfits. Off: try single items',
        mix_match_on: '✨ Mix & Match: ON — select multiple items',
        mix_match_off: '👕 Single item mode',
        mix_match_off_kept_primary: '👕 Mix & Match off — kept primary item',
        ...
        quality_warning: {
            ...
            multiple_people: '⚠️ Image contains multiple people — AI may confuse which garment to use',
            on_model_image: '💡 Image shows clothing worn by a model — results may vary. Using a flat-lay or product photo is recommended',
            has_text_overlay: '⚠️ Image has text/watermark overlay — may affect try-on quality',
            ...
            duplicate_category: '⚠️ You selected {count} {category} items — AI will try to stack them. Consider selecting only 1 {category}',
            replace_or_stack: 'Replace {old} with {new}?',
            replace_btn: 'Replace',
            stack_btn: 'Stack',
            combo_dress_conflict: '⚠️ A dress covers both upper and lower body — AI will skip tops/bottoms when a dress is selected',
            outfit_transfer_title: '📸 This image shows someone wearing clothes',
            outfit_transfer_full: '🔄 Transfer entire outfit',
            outfit_transfer_full_desc: 'Copy the full outfit from this image onto your model',
            outfit_transfer_single: '👕 Extract single item ({category})',
            outfit_transfer_single_desc: 'Only extract the {category} from this image',
            outfit_transfer_tip: '💡 Product photos (white background) give more accurate results!',
        },
