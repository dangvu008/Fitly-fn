(function (global) {
    ...
    global.FITLY_LOCALES.vi = {
        ...
        session_expired_relogin: 'Phiên đăng nhập đã hết hạn. Vui lòng đăng nhập lại rồi thử lại.',
        ...
        // Gems packages
        gems_store_title: 'Cửa hàng Gems 💎',
        gems_benefit_1: 'Thử đồ không giới hạn',
        gems_benefit_2: 'AI stylist cá nhân',
        gems_benefit_3: 'Hoàn gem nếu không hài lòng',
        gem_per_try: '/gem',
        ...
        payment_note: 'Thanh toán an toàn qua Polar.sh',
        ...
        error_overlay: {
            title: 'Huhu, lỗi mất rồi... 🥺',
            apology: 'Mình xin lỗi bạn nhiều nha, thử lại giúp mình~',
        },
        ...
        mix_match_toggle: 'Phối đồ',
        mix_match_toggle_tip: 'Bật: phối nhiều món. Tắt: thử từng món',
        mix_match_on: '✨ Chế độ phối đồ: BẬT — chọn nhiều món',
        mix_match_off: '👕 Chế độ thử đồ: chỉ 1 món',
        mix_match_off_kept_primary: '👕 Đã tắt phối đồ — giữ lại item chính',
        ...
        quality_warning: {
            ...
            multiple_people: '⚠️ Ảnh chứa nhiều người — AI có thể nhầm lẫn món đồ cần dùng',
            on_model_image: '💡 Ảnh quần áo có người mẫu mặc — kết quả có thể khác. Nên dùng ảnh sản phẩm trải phẳng',
            has_text_overlay: '⚠️ Ảnh có chữ/watermark — có thể ảnh hưởng chất lượng thử đồ',
            ...
            duplicate_category: '⚠️ Bạn đã chọn {count} {category} — AI sẽ cố mặc chồng lên nhau. Nên chọn 1 {category} thôi',
            replace_or_stack: 'Thay thế {old} bằng {new}?',
            replace_btn: 'Thay thế',
            stack_btn: 'Chồng thêm',
            combo_dress_conflict: '⚠️ Váy đã bao gồm thân trên và dưới — AI sẽ bỏ qua áo/quần khi có váy',
            outfit_transfer_title: '📸 Ảnh này có người đang mặc đồ',
            outfit_transfer_full: '🔄 Chuyển toàn bộ outfit',
            outfit_transfer_full_desc: 'Lấy toàn bộ outfit từ ảnh này mặc vào bạn',
            outfit_transfer_single: '👕 Chỉ lấy 1 món ({category})',
            outfit_transfer_single_desc: 'Chỉ lấy đúng {category} từ ảnh này',
            outfit_transfer_tip: '💡 Ảnh sản phẩm (nền trắng) cho kết quả chính xác hơn!',
        },
